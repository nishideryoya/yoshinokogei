...
<main class="py-5">
    <div class="container">
        ...
        <div class="d-flex flex-wrap gap-2 mb-5 justify-content-center">
            <a href="<?php echo esc_url(yoshino_news_archive_url()); ?>" class="btn btn-sm rounded-pill <?php echo is_home() && !is_category() ? 'btn-dark' : 'btn-outline-dark'; ?>">すべて</a>
        ...
        <?php else : ?>
            <p class="text-center text-secondary py-5">現在お知らせはありません。</p>
        <?php endif; ?>
    </div>
</main>
